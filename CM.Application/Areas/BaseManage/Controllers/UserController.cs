...
namespace CM.Application.Web.Areas.BaseManage.Controllers
{
    ...
    public class UserController : MvcControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetUserEntity(string account_realName)
        {
            var data= userBLL.GetUserEntity(account_realName);
        ...
        public ActionResult SaveForm(string keyValue, UserEntity entity)
        {
            ...
            userBLL.SaveForm(keyValue, entity);
