using CM.Application.Cache;
using CM.Application.Entity.SystemManage.ViewModel;
using CM.Util;
...
using CM.Application.Entity.AuthorizeManage;
...
namespace CM.Application.Web.Controllers
{
    ...
    public class ClientDataController : MvcControllerBase
    {
        ...
        {
            var dataList = dataItemCache.GetDataItemList().Where(t=>t.EnCode!=null);
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetDepartmentDataJson()
        {
            var jsonData = new
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetRoleDataJson()
        {
            var jsonData = new
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetDataItemJson()
        {
            var jsonData = new
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GetModuleButtonDataJson()
        {
            var jsonData = new
            {

                moduleButtonData = this.GetModuleButtonData(),          //功能按钮
            };
            return ToJsonResult(jsonData);
        }
        #endregion
