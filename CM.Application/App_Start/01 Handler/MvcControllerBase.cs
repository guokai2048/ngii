...
namespace CM.Application.Web
{
    ...
    public abstract class MvcControllerBase : Controller
    {
        ...
        /// <returns></returns>
        protected virtual ActionResult Success(string message, string sysID)
        {
            return Content(new AjaxResult { type = ResultType.success, message = message, resultdata = sysID }.ToJson());
        }
        /// <summary>
        /// 返回成功消息
        /// </summary>
        ...
        /// <param name="message">消息</param>
        /// <returns></returns>
        protected virtual ActionResult ErrorV(string message)
        {
            message = message.Replace("\r\n", "<br/>");
            return Content(new AjaxResult { type = ResultType.info, message = message }.ToJson());
        }
    }
}
