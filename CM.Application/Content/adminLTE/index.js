(function ($) {
    ...
    $.CMtab = {
        ...
        refreshTab2: function (currentUrl, dataUrl) {
        ...
        init: function () {
            $('.menuItem').on('click', $.CMtab.addTab);
            $('.menuTabs').on('click', '.menuTab i', $.CMtab.closeTab);
