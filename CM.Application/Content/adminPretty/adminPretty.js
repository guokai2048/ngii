...
var tablist = {
    newTab: function(n) {
        ...
        $(".menuTab").each(function() {
            if ($(this).data("id") == t) return $(this).hasClass("active") || ($(this).addClass("active").siblings(".menuTab").removeClass("active"), $.CMtab.scrollToTab(this), $("#mainContent .LRADMS_iframe").each(function() {
    ...
    n.CMtab = {
        ...
        activeTab: function() {
            ...
            n(this).hasClass("active") || (n("#mainContent .LRADMS_iframe").each(function() {
                ...
                !1
            }), n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.CMtab.scrollToTab(this));
        ...
        closeTab: function() {
            ...
            "fast"), n(this).parents(".menuTab").remove(), n("#mainContent .LRADMS_iframe").each(function() {
                ...
                if (n(this).data("id") == i) return n(this).remove(),
                !1
            }), n.CMtab.scrollToTab(n(".menuTab.active"))),
        ...
        addTab: function() {
            ...
            return (i != "" && top.$.cookie("currentmoduleId", i, {
                ...
                if (n(this).data("id") == t) return n(this).hasClass("active") || (n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.CMtab.scrollToTab(this), n("#mainContent .LRADMS_iframe").each(function() {
                    if (n(this).data("id") == t) return n(this).show().siblings(".LRADMS_iframe").hide(),
                    !1
                })),
                r = !1,
                !1
            }), r && (f = '<a href="javascript:;" class="active menuTab" data-value=' + i + ' data-id="' + t + '">' + u + '<div class="tab_close "><\/div><\/a>', n(".menuTab").removeClass("active"), e = '<iframe class="LRADMS_iframe" id="iframe' + i + '" name="iframe' + i + '"  width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless><\/iframe>', n("#mainContent").find("iframe.LRADMS_iframe").hide(), n("#mainContent").append(e), CM.loading({
                isShow: !0
            }), n("#mainContent iframe:visible").load(function() {
                CM.loading({
                    isShow: !1
                })
            }), n(".menuTabs .page-tabs-content").append(f), n.CMtab.scrollToTab(n(".menuTab.active"))), n(this).parents(".popover-moreMenu").hide(), n(this).parents(".popover-menu").hide(), n(this).parents(".popover-menu-sub").hide(), !1)
        },
        scrollTabRight: function() {
            var f = Math.abs(parseInt(n(".page-tabs-content").css("margin-left"))),
            e = n.CMtab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
            ...
            t = n(t).next();
            r = n.CMtab.calSumWidth(n(t).prevAll());
        ...
        scrollTabLeft: function() {
            ...
            for (t = n(".menuTab:first"), i = 0; i + n(t).outerWidth(!0) <= f;) i += n(t).outerWidth(!0),
            t = n(t).next();
            if (i = 0, n.CMtab.calSumWidth(n(t).prevAll()) > r) {
                while (i + n(t).outerWidth(!0) < r && t.length > 0) i += n(t).outerWidth(!0),
                t = n(t).prev();
                u = n.CMtab.calSumWidth(n(t).prevAll())
            }
        ...
        scrollToTab: function(t) {
            var f = n.CMtab.calSumWidth(n(t).prevAll()),
            e = n.CMtab.calSumWidth(n(t).nextAll()),
            o = n.CMtab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
        ...
        init: function() {
            n(".menuTabs").on("click", ".menuTab .tab_close", n.CMtab.closeTab);
            n(".menuTabs").on("click", ".menuTab", n.CMtab.activeTab);
            n(".tabLeft").on("click", n.CMtab.scrollTabLeft);
            n(".tabRight").on("click", n.CMtab.scrollTabRight);
            n(".tabReload").on("click", n.CMtab.refreshTab);
            ...
            n(".tabCloseOther").on("click", n.CMtab.closeOtherTabs);
            n(".fullscreen").on("click",
            function() {
                n(this).attr("fullscreen") ? (n(this).removeAttr("fullscreen"), n.CMtab.exitFullscreen()) : (n(this).attr("fullscreen", "true"), n.CMtab.requestFullScreen())
            })
        }
    };
    n.CMindex = {
        ...
        loadMenu: function(t) {
            var e = !1,
            o = n(".lea-Head").width() - n.CMtab.calSumWidth(n(".lea-Head").children().not(".left-bar")),
            i = top.CM.data.get(["authorizeMenu"]),
            r = "",
            u = 0,
            s = "",
            f = "";
            ...
            function(t) {
                ...
                e,
                c;
                h.F_ParentId == "0" && (e = "", e += '<li class="treeview">', e += "<a>", e += '<i class="' + h.F_Icon + '"><\/i><span>' + h.F_FullName + "<\/span>", e += "<\/a>", c = n.CMindex.jsonWhere(i,
                function(n) {
                ...
                n(".menuiframe").unbind();
                n(".menuiframe").on("click", n.CMtab.addTab);
