...
function (n, t) {
    ...
    n.fn.comboBoxTree = function (i) {
        ...
        f = {
            ...
            loadData: function (i) {
                ...
                function (n, t) {
                    var r = top.CM.data.get(["dataItem", i.dataItemName, t[i.text]]);
                    r != "" && (t[i.text] = r);
                    i.data.push(t)
                })) : i.data = r
            },
        ...
        for (u in t) if (i = e.find("#" + u), i.attr("id")) {
            ...
            switch (f) {
                ...
                case "datepicker":
                    ...
                    break;
                case "datepickerV":
                    i.val(formatDate(r, "yyyy-MM-dd HH:mm:ss"));
                    break;
                case "uploadify":
                case "webUploader":
                    i.uploadifyExSet(r);
    ...
    n.fn.authorizeButton = function () {
        ...
        r = top.CM.data.get(["authorizeButton", u]);
    ...
    n.fn.authorizeColModel = function () {
        ...
        t = top.CM.data.get(["authorizeColumn", u]);
...
formatDate = function (n, t) {
    return CM.formatDate(n, t)
};
toDecimal = function (n) {
    return CM.toDecimal(n)
};
request = function (n) {
    return CM.request(n)
};
changeUrlParam = function (n, t, i) {
    return CM.changeUrlParam(n, t, i)
};
$.currentIframe = function () {
    return CM.currentIframe()
};
$.isbrowsername = function () {
    return CM.isbrowsername()
};
...
$.isNullOrEmpty = function (n) {
    return CM.isNullOrEmpty(n)
};
IsNumber = function (n) {
    return CM.isNumber(n)
};
IsMoney = function (n) {
    return CM.isMoney(n)
};
$.arrayClone = function (n) {
    return CM.arrayCopy(n)
};
$.windowWidth = function () {
    return $(window).width()
};
...
checkedArray = function (n) {
    return CM.checkedArray(n)
};
checkedRow = function (n) {
    return CM.checkedRow(n)
};
$(function () {
